...
- RailSignal Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called RailSignal Lite. It should be a full-viewport rail-switching timing game where the player routes signal pulses through moving junctions, with live score, level, pause, restart, settings overlay, saved preferences, and clear keyboard/mouse controls. The generated app must f…
...
- Gameplay - RailSignal Lite
- Game Settings - RailSignal Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - RailSignal Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - RailSignal Lite
